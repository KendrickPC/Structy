...
// 1. Set a previousNode = new Node(null);
// 2. set currentNode = head;

// 3. While current !== null, do something:
// 4. if (currentNode.val === targetVal, previous.next = current.next)
// x. Increment previousNode = previousNode.next
// x. Increment currentNode = currentNode.next
// x. Code for edge cases:
// x. Return head;
...
const removeNode = (head, targetVal) => {
  ...
  if (previous.val === targetVal) return current;
  if (head === null) return null;
  if (head === targetVal) return null;
