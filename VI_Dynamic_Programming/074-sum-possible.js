...
numbers. The function should return a boolean indicating whether or not it is possible to create the amount by summing numbers of the array. 
...
const sumPossible = (amount, numbers, memo={}) => {
  ...
  for (let num of numbers) {
    ...
    if (sumPossible(remainder, numbers, memo) === true) return true;
  }
  memo[amount] = false;
  return false;
};
